...
public class ChatClient3  extends UnicastRemoteObject implements ChatClient3IF {
	...
	private String serviceName = "GroupWebService";
	...
	public ChatClient3(ClientRMIGUI aChatGUI, String userName) throws RemoteException {
		...
		this.name = userName;
		this.clientServiceName = "ServiceD'éEcouteClient_" + userName;
	}
	...
	public void startClient() throws RemoteException {		
		...
		try {
			...
			JOptionPane.showMessageDialog(
					chatGUI.frame, "Le serveur semble indisponible\nVeuillez réessayer plus tard",
		...
		System.out.println("Le client écoute le serveur RMI en cours d'exécution...\n");
	}
